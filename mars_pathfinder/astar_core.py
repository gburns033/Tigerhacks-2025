...
def astar(start: Tuple[int,int], goal: Tuple[int,int],
          ...
          *, weight: float = 1.0, epsilon: Optional[float] = None,
          max_expansions: Optional[int] = None, max_time_sec: Optional[float] = None,
    ...
    closed = set(); expansions = 0; expanded_order = []
    best_goal_cost = None; best_goal_node = None
    ...
    while openh:
        ...
        closed.add(u); expanded_order.append(u); expansions += 1
